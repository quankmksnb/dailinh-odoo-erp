# -*- coding: utf-8 -*-
"""L2 Integration test (TransactionCase, DB thật) cho dl.rbac.feature —
service quản lý vai trò/phân quyền cho màn "Phân quyền" (dl_base/models/
dl_rbac.py). Sheet nguồn: DlRbacFeature trong Report_5_1_UnitTests_L1.xlsx.

Bổ sung 2026-08-11 (Round 2/3 — trước đó 0% coverage, dl_base chưa từng có
thư mục tests/)."""
...
class TestDlRbacFeature(TransactionCase):
    ...
    def test_delete_role_system_role_blocked(self):
        """TC-UNIT-DlRbacFeature-005 — vai trò do module cài (có external id)
        không được xoá."""
