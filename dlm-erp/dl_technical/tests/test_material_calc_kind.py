...
class TestMaterialCalcKind(TransactionCase):
    ...
    # T6: thu hồi phế liệu phải quy đổi số cây sang kg (🔴)
    def test_t6_recovery_converts_unit_to_kg(self):
        """1 cây hao hụt x 8.5 kg/cây x 55% x 8.000đ/kg = 37.400đ.
        ...
        # quantity 10, hao hụt 10% nên effective 11, lượng hao hụt đúng 1 cây.
    ...
    def test_t6b_recovery_for_material_sold_by_kg(self):
        """Vật tư mua theo kg: hao hụt đã là kg nên hệ số quy đổi là 1, không
        đòi khai khối lượng mỗi đơn vị. Khai 0 sẽ biến tiền phế liệu thành 0."""
        scrap = self.Product.create({
