...
class TestSmartDomains(DlInventoryCase):
    ...
    def test_sm04_khong_gan_don_thi_danh_sach_rong(self):
        """Phiếu giao chưa gắn đơn thì danh sách rỗng (form khoá bảng và mời
        chọn đơn, đây là nhánh guard ở view)."""
    ...
    def test_sm07_khong_gia_thi_canh_bao(self):
        """Nhận mặt hàng của NCC chưa có bảng giá đang áp dụng thì dải vàng
        phải nêu đích danh, nhưng không chặn nhận hàng."""
    ...
    def test_sm07_co_gia_thi_khong_canh_bao(self):
        """Mặt hàng đã có bảng giá đang áp dụng từ đúng NCC thì không cảnh báo."""
    ...
    def test_sm07_khac_ncc_van_canh_bao(self):
        ...
        này vẫn phải cảnh báo (giá vốn tính theo đúng NCC giao hàng)."""
