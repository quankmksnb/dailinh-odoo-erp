...
class TestLotAndCost(DlInventoryCase):
    ...
    def test_vat_tu_mac_dinh_theo_lo(self):
        """§3.4: vật tư và BTP tạo mới thì tự theo lô, không phải nhớ tick tay.

        Lô là mắt xích duy nhất truy ngược hàng lỗi về NCC và ngày nhập. Vật tư
        nhập khi chưa bật lô thì vĩnh viễn không có lô, không vá lại được.
        """
    ...
    def test_hang_thuong_mai_khong_theo_lo(self):
        ...
        nên đừng bắt thủ kho nhập lô cho nó."""
    ...
    def test_so_lo_tu_sinh_khi_nhan_hang(self):
        ...
        sai, trong khi lô là mắt xích truy vết.
        """
    ...
    def test_gia_von_khong_doi_sau_khi_nhap_kho(self):
        ...
        nhập, hai nguồn tranh nhau làm giá vốn nhảy theo từng phiếu nhập, kéo
        theo giá báo khách nhảy theo, phá luồng duyệt giá 3 nấc.
        """
    ...
    def test_khong_co_dinh_gia_ton_kho(self):
        ...
        `account` và `stock_account` đã gỡ khỏi dự án (2026-08-11). Nếu ai cài
        lại, `stock_account` (auto_install) quay lại và mở đường bật AVCO. Test
        này fail ngay, thay vì để phát hiện khi giá báo khách đã sai.
        """
