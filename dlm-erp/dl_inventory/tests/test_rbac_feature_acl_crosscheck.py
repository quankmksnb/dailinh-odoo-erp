...
class TestRbacFeatureAclCrosscheck(DlInventoryCase):
    ...
    def test_toan_bo_6_feature_kho_deu_ton_tai(self):
        ...
        thiếu và không trùng code (code_uniq)."""
    ...
    def test_model_id_dung_hoac_co_y_bo_trong(self):
        ...
        khớp đúng model kỳ vọng, hoặc cố ý để trống (kiểm kê/phế liệu)."""
    ...
    def test_thu_kho_co_quyen_doc_moi_model_co_model_id(self):
        ...
        feature K1 có model_id đều phải có ít nhất một dòng ir.model.access
    ...
    def test_khong_co_feature_stock_nao_ngoai_6_cai_da_biet(self):
        ...
        feature code tiền tố stock_ nào ngoài 6 cái đã khai. Đổi code nghĩa
        là sinh bản ghi mới và feature cũ thành mồ côi, đúng như cảnh báo
        trong comment của rbac_features.xml."""
